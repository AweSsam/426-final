...
import { RoomDetails, SeatDetails, Seat } from './room-view/room-view.models';
...
export class RoomViewService {
  ...
  /** Returns a list of room details from the backend database table using the backend HTTP get request.
